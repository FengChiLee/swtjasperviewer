...
//    }
    ...
    private String getLinkToolTip(JRPrintHyperlink link) {
        ...
        case REFERENCE:
            ...
            break;
        case LOCAL_ANCHOR: //JRHyperlink.HYPERLINK_TYPE_LOCAL_ANCHOR:
            if (link.getHyperlinkAnchor() != null)
                toolTip = "#" + link.getHyperlinkAnchor(); //$NON-NLS-1$
            break;
        case LOCAL_PAGE: //JRHyperlink.HYPERLINK_TYPE_LOCAL_PAGE:
            if (link.getHyperlinkPage() != null)
                toolTip = "#page " + link.getHyperlinkPage(); //$NON-NLS-1$
            break;
        case REMOTE_ANCHOR: //JRHyperlink.HYPERLINK_TYPE_REMOTE_ANCHOR:
            ...
            break;
        case REMOTE_PAGE: //JRHyperlink.HYPERLINK_TYPE_REMOTE_PAGE:
