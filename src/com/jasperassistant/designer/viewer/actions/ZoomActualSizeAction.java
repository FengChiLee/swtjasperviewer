...
public class ZoomActualSizeAction extends AbstractReportViewerAction {
	...
	private static final ImageDescriptor ICON	=	
		ImageDescriptor.createFromFile(ZoomActualSizeAction.class, "images/zoomactual.gif"); //$NON-NLS-1$
	private static final ImageDescriptor DISABLED_ICON	=	
		ImageDescriptor.createFromFile(ZoomActualSizeAction.class, "images/zoomactuald.gif"); //$NON-NLS-1$
