...
public class NextPageAction extends AbstractReportViewerAction {
	private static final ImageDescriptor ICON	=	
		ImageDescriptor.createFromFile(NextPageAction.class, "images/next.gif"); //$NON-NLS-1$
	private static final ImageDescriptor DISABLED_ICON	=	
		ImageDescriptor.createFromFile(NextPageAction.class, "images/nextd.gif"); //$NON-NLS-1$

	/**
	 * @see AbstractReportViewerAction#AbstractReportViewerAction(IReportViewer)
	 */
	public NextPageAction(IReportViewer viewer) {
		super(viewer);
