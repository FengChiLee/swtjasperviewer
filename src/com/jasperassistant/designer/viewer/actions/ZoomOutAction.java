...
public class ZoomOutAction extends AbstractReportViewerAction {
	...
	private static final ImageDescriptor ICON	=	
		ImageDescriptor.createFromFile(ZoomOutAction.class, "images/zoomminus.gif"); //$NON-NLS-1$
	private static final ImageDescriptor DISABLED_ICON	=	
		ImageDescriptor.createFromFile(ZoomOutAction.class, "images/zoomminusd.gif"); //$NON-NLS-1$
