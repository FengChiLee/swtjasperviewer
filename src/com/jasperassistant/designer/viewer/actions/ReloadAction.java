...
/**
 * Viewer document reload action
 * 
 * @author Peter Severin (peter_p_s@users.sourceforge.net)
 */
public class ReloadAction extends AbstractReportViewerAction {

	private static final ImageDescriptor ICON	=	
		ImageDescriptor.createFromFile(ReloadAction.class, "images/reload.gif"); //$NON-NLS-1$
	private static final ImageDescriptor DISABLED_ICON	=	
		ImageDescriptor.createFromFile(ReloadAction.class, "images/reloadd.gif"); //$NON-NLS-1$
	
	/**
	 * @see AbstractReportViewerAction#AbstractReportViewerAction(IReportViewer)
	 */
	public ReloadAction(IReportViewer viewer) {
		super(viewer);
	...
	protected boolean calculateEnabled() {
		return getReportViewer().canReload();
	}
}
